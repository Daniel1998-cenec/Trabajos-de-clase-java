...
/**
 * Es la funcion donde estoy realizando todos los ejercicios del reloj apocalipsis
 * @author Daniel Cesar Vargas Holguin
 *
 */
public class Principal {
/**
 * Es la funcion main donde estoy realizando todos los ejercicios del reloj apocalipsis
			...
			do {
				...
				do {System.out.println("\n\t0 - Eleccion aleatoria" + "\n\t1 - Comienza una pandemia"
					...
					case 6:
						...
						break;
					case 7:
						System.out.println("El egoísmo de una gran empresa contribuye a aumentar la contaminación global");
				...
				}while(eleccionSuceso < 1 || eleccionSuceso > 10);
