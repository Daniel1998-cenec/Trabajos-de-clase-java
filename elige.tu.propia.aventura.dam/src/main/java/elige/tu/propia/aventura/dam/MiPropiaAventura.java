package elige.tu.propia.aventura.dam;

import java.util.Scanner;

public class MiPropiaAventura {
...
//------------------------------------------------------------------------------------------------------------------------------------------------		
		...
		case 3:
			System.out.println("Se lía a metralletazos, a tí" + " no te mata,\n"
					...
					+"\n\t1 - Los "+nAlumnos+" alumnos que mueren se tranforma en zombi"
					+"\n\t2 - Me doy cuenta en el fondo de mi ser que tengo un super poder..."); 
			opcion = Byte.parseByte(scan.nextLine());
			if(opcion==1) {
				System.out.println("Los "+nAlumnos+" alumnos que mueren se tranforma en zombi, y matan al mono. Empieza el apocalipsis zombi... ");
			} else {System.out.println("Me doy cuenta en el fondo de mi ser que tengo un super poder, en el cual, realiza un kamemeha por el podre cagarme al mono y salvar "+nAlumnos+" alumnos.");
			}
			break;
		default:
